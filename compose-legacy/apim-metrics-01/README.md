# Example 01 for Metrics Centralization for WebMethods API Management
...
- Ensure the resources prerequisites are satisfied, for example ensure Elasticsearch need to have the kernel parameter `vm.max_map_count` set to at least a value of `262144`
  - An example on how to do this is [here](https://github.com/ibm-webmethods-continuous-delivery/2l-unattended-installation-templates/tree/main/09.utils/alpine-set-elk-prerequisites)