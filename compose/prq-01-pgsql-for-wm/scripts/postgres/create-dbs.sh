...
_create_database_and_user "${EX01_WM_DB_NAME}" "${EX01_WM_DB_USER_NAME}" "${EX01_WM_DB_USER_PASS}"
_create_database_and_user "${EX01_WM_ARCHIVE_DB_NAME}" "${EX01_WM_ARCHIVE_DB_USER_NAME}" "${EX01_WM_ARCHIVE_DB_USER_PASS}"
