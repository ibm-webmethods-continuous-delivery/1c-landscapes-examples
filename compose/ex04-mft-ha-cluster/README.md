...
- `EX04_HA_PORT_PREFIX`: Port prefix for all exposed services (default: 404)
- `EX04_HA_TEST_PK_SECRET`: Passphrase for certificate encryption (default: TestOnly123)
...
- Private key passphrase (`EX04_HA_TEST_PK_SECRET`) is exposed in environment variables
...
Check port mappings match your EX04_HA_PORT_PREFIX setting.
