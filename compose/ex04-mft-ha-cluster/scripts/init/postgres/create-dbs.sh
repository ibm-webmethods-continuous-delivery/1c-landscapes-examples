...
_create_database_and_user "${EX04_HA_WM_DB_NAME}" "${EX04_HA_WM_DB_USER_NAME}" "${EX04_HA_WM_DB_USER_PASS}"
_create_database_and_user "${EX04_HA_WM_ARCHIVE_DB_NAME}" "${EX04_HA_WM_ARCHIVE_DB_USER_NAME}" "${EX04_HA_WM_ARCHIVE_DB_USER_PASS}"
